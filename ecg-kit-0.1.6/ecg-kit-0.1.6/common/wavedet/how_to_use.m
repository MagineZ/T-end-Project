...
sigdir='D:\duke box\Box Sync\fECG_project\qt-database-1.0.0\qt-database-1.0.0\'; % path to the signal files
headir=sigdir; % path to the header files
matdir='D:\duke box\Box Sync\fECG_project\qt-database-1.0.0\qt-database-1.0.0\eval\';  % path to the annotation files (to be saved)
