function  [Om0,Om0_real] = fECG_shrinkage_noq( x0,x0_real, current_beats, OptimalShrinkageOpt,num_nonlocal, ifauto)
...
MaximalQTp = ceil((median(RRI)+iqr(RRI))*3/8);
MaximalQTt = ceil((median(RRI)+iqr(RRI))*5/8);
