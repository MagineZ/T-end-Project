function  [Om0,Om0_real] = ECG_shrinkage02( x0,x0_real, current_beats, OptimalShrinkageOpt, sigma_coeff,ifauto)
...
RRI = [RRI(1) RRI];
MaximalQTp = ceil(quantile(RRI,0.7)*4/8);
MaximalQTt = ceil(quantile(RRI,0.7)*4/8);
