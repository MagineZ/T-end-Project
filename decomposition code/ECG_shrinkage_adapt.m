function  [Om0,Om0_real] = ECG_shrinkage_adapt( x0,x0_real, current_beats, OptimalShrinkageOpt, I2_amp, ifauto)
...
%adapt sigma
x0_amp = median(abs(x0(current_beats)));
sigma_ratio = max(I2_amp/x0_amp*10,1); 
sigma_ratio = min(sigma_ratio,3);
sigma_ratio
sigma = max(sigma_ratio*sigma,I2_amp);
