function  [Om0,Om0_real] = ECG_shrinkage( x0,x0_real, current_beats, OptimalShrinkageOpt, I2_amp, ifauto)
...
RRI = [RRI(1) RRI];
MaximalQTp = ceil(quantile(RRI,0.9)*4/8);
MaximalQTt = ceil(quantile(RRI,0.9)*4/8);
...
if I2_amp<sigma
    ...
    sigma_ratio = I2_amp/sigma;
end
sigma = sigma_ratio*sigma;
